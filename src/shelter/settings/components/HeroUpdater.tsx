...
const LOGO_URL =
  "https://github.com/Legcord/Branding/raw/main/assets/legcord-banner.png";
...
const HeroUpdater = () => {
  ...
  const [updateAvailable, setUpdateAvailable] = createSignal<boolean | null>(
    null
  );
